# ----------------------------------------------------------------------
# Name:        professor_contact_extractor.py
# Purpose:     Do the web scraping to collect professors' contacts from
#               SJSU website and allow students the easy access to them
#
# Author(s): Dasom Lee
# ----------------------------------------------------------------------
"""
Gathering data from various web pages and storing it in a CSV file:

This program is designed to accept a CSV file name as a command-line
argument. It begins by accessing and parsing the SJSU faculty index
webpage, which serves as a gateway to additional web pages containing
detailed information about the faculty and staff.

The extracted information comprises the last name, first name, email
address, phone number, and educational background of each staff member.
"""
...
# Enter the base URL here
BASE = 'https://sjsu.edu/people/'


def read_url(url):
    """
    This function takes a URL as input and fetch the
    corresponding Beautiful Soup object. In case of any errors during
